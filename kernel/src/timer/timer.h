...
#define TISR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x018))
#define TIER_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x01C))
#define TCRR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x028))
#define TMAR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x038))
#define TCLR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x024))
#define TTGR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x030))
#define TLDR_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x02C))
#define TWER_GPT(number)          *((volatile uint32_t*) (HAL_TIMER(number) + 0x020))
